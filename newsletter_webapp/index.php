...
function sendPersonalLocationPage($id)
{
 ...
 //  $html .= '<br/><br/>';
  ...
  if ($GLOBALS["msg"] == 'Subscriber not found for the email address shown below. If you wish to subscribe click on "Subscribe."') {
       $html .= '<br /><br />E-mail: '.$email.'<br /><br />';

       $html .= '<p><h2> <a href="http://2civilitynews.2civility.org/lists/?p=subscribe">Subscribe</a></h2></p>';
       }
       elseif ($GLOBALS["msg"] == 'Your email below is listed in our "Do not send" list, which means that you unsubscribed to 2Civility News. If you wish to subscribe click on "Subscribe."') {
       $html .= '<br /><br />E-mail: '.$email.'<br /><br />';
...
// Add in Privacy Statement
  $html .='<p>Privacy Statement<br /><br />You will receive no more than one newsletter per month and you may unsubscribe at any time. Your privacy is important to us. We do not share your information and we do not collect other data.</p>';

 // Remove unsubscribe link from bottom of Subscribe page
